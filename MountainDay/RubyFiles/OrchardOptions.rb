...
class OrchardOptions
  def display
    ...
    heading1 = Text.new('We are glad you are here on this crisp fall afternoon. What do you want to do here?', x: 65, y: 80, color: 'white', size: 30)  
    ...
    hayrideMessage = Text.new('Go on a hayride', x: 950, y: 950, color: 'white', size: 25, z: 8)
