...
class DowntownInfo
    def display
        ...
        heading2 = Text.new("With multiple galleries, mini shops, and great coffee, Northampton provides perfect places for celebrating Mountain Day!", x: 145, y: 120, color: 'black', size: 25, z: 3)
