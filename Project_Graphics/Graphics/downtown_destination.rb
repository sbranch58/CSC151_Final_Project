...
class Destination
    def display()
        ...
        @choice1 = Image.new('./Images/herells.jpeg', x: 30, y: 200, width: 300, height: 150, z: 10)
        @message1 = Text.new("Herells to get ice cream", x: 55, y: 360, color: 'black', size: 25, z: 20) 


        @choice2 = Image.new('./Images/limered.jpeg', x: 380, y: 200, width: 300, height: 150, z: 10)
        @message2 = Text.new("Lime Red", x: 400, y: 360, color: 'black', size: 25, z: 20)


        @choice3 = Image.new('./Images/raven.jpeg', x: 30, y: 395, width: 300, height: 150, z: 10)
