...
class HerrellFlavor
    def display()
        ...
        @choice1 = Image.new('./Images/coffee_icecream.jpeg', x: 30, y: 200, width: 300, height: 150, z: 10)
        ...
        @choice2 = Image.new('./Images/chocolate_icecream.webp', x: 380, y: 200, width: 300, height: 150, z: 10)
        ...
        @choice3 = Image.new('./Images/vanilla_icecream.jpeg', x: 30, y: 395, width: 300, height: 150, z: 10)
        ...
        # @choice4 = Image.new('./Images/birthday.webp', x: 380, y: 295, width: 300, height: 150, z: 10)
        # @message4 = Text.new('Tell the its your birthday', x: 400, y: 460, color: 'black', size: 25, z: 20) 
        # @response4 = Text.new("Coffee", x: 55, y: 260, color: 'black', size: 25, z: 30) 
    end
