...
def picture()
    ...
    print "1. Force them to do a dramatic renactment of the book with you \n2. Talk to them abot a new book you found that while being a picture book, is interesting in a normal, and appropriate manner \n"
    choice = gets.chomp
    choice = choice.to_i
    if choice == 1
        $score << choice
