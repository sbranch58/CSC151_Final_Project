...
class Rock # class for picking a book on rocks 
    def display() # display all content in this class 
        ...
        possible_rocks = ["You somehow get poodle. It isn't even a rock. How did you do that? ", "Pebble. Is this book making fun of you? ", "A rock shaped like a penguin. Guess you can't fly. ", "The rock that you tipped over. "]
